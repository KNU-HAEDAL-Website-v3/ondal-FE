...
- HOJ는 **같은 앱 안의 모드** - 별도 빌드·Pages 프로젝트·도메인이 없다 (2026-09-19 [결정 9](https://github.com/KNU-HAEDAL-Website-v3/ondal-docs/blob/main/docs/decisions/9-hoj-ondal-%EB%82%B4%EB%B6%80-%EB%AA%A8%EB%93%9C%EB%A1%9C-%ED%86%B5%ED%95%A9.md), 별도 앱 분리(결정 8)는 철회). 사이드바 "HOJ로 이동하기" → 확인 팝업 → `/problems`(HojShell)
