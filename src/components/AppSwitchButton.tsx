...
import { entryPath, MODE_LABEL, type AppMode } from '@/lib/appSwitch'

const DESCRIPTION: Record<AppMode, string> = {
  hoj: 'HOJ에서는 분반·과제와 무관하게 문제를 골라 풀고 바로 채점받을 수 있어요. 문제 목록에서 시작하고, 돌아올 때는 지금 보던 화면으로 돌아와요.',
 ...
 * 이동 후 목적지: HOJ 는 늘 문제 목록, Ondal 은 그 모드에서 마지막에 보던 화면 (lib/appSwitch entryPath).
 */
      ...
      <AlertDialog open={open} onOpenChange={setOpen}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={() => navigate(entryPath(to))}>네, 이동할게요</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </>
