...
const STATUS_META: Record<SubmissionStatus, { label: string; className: string }> = {
  ...
  SUBMITTED: { label: '제출', className: 'bg-success-bg text-success' },
  SUBMITTED_EXTRA: { label: '제출(추가)', className: 'bg-success-bg text-success' },
  LATE: { label: '지각', className: 'bg-caution-bg text-caution' },
}
